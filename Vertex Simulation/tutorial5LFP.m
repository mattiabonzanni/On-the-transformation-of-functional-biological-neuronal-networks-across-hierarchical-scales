function Results=tutorial5LFP(Density,a,b)
%% Tissue parameters
...
TissueParams.Y = 400;
TissueParams.Z = 650;
TissueParams.neuronDensity = Density;
neurons=(TissueParams.X/1000)*(TissueParams.Y/1000)*(TissueParams.Z/1000)*TissueParams.neuronDensity;
...
[meaX, meaY, meaZ] = meshgrid(0:a:2000, 200, 700:b:0);
RecordingSettings.meaXpositions = meaX;
RecordingSettings.meaYpositions = meaY;
RecordingSettings.meaZpositions = meaZ;
RecordingSettings.minDistToElectrodeTip = 20;
RecordingSettings.v_m = 1:neurons;
